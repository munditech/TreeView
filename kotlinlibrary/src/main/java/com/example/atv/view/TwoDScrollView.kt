...
class TwoDScrollView : FrameLayout {
   ...
   */
       ...
       */mIsBeingDragged = !mScroller!!.isFinished
            ...
            MotionEvent.ACTION_CANCEL, MotionEvent.ACTION_UP ->        /* Release the drag */mIsBeingDragged = false
        }
   ...
   */
       ...
       */
                ...
                if (focusCandidate == null) {
                    ...
                    val viewIsCloserToVerticalBoundary = topFocus && viewTop < focusCandidate.top ||
                            !topFocus && viewBottom > focusCandidate.bottom
                    val viewIsCloserToHorizontalBoundary = leftFocus && viewLeft < focusCandidate.left ||
    ...
    private fun scrollToChild(child: View) {
        ...
        /* Offset from child's local coordinates to TwoDScrollView coordinates */offsetDescendantRectToMyCoords(child, mTempRect)
        val scrollDelta = computeScrollDeltaToGetChildRectOnScreen(mTempRect)
        if (scrollDelta != 0) {
    ...
    override fun onRequestFocusInDescendants(direction: Int, previouslyFocusedRect: Rect): Boolean {
        ...
        val nextFocus = (if (previouslyFocusedRect == null) FocusFinder.getInstance().findNextFocus(this, null, direction) else FocusFinder.getInstance().findNextFocusFromRect(this,
